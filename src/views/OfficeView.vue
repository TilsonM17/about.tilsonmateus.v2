<template>
    <div class="mb-5">
        <p class="text-4xl block uppercase
                ...
                transition duration-150 mb-5">My Office</p>


        <p class="font-bold">Step by Step I am going improve my Setup and with consequence improve my performance.</p>
        <br>
        <p>
            Below, you will see a short list the tools I use.
        </p>
    </div>
