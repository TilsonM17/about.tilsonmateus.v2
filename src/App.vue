    ...
    <section class="py-10 md:py-16">
      ...
      <div class="container max-w-screen-xl mx-auto px-4">
        ...
        <div class="text-center">
          ...
          <h1 class="font-normal text-gray-900 text-4xl md:text-7xl leading-none mb-8">Fullstack Developer</h1>

          <p class="font-normal text-gray-600 text-md md:text-xl mb-16">I have a passion for software. I enjoy creating
            tools that make life easier for people.</p>

          <a href="https://cal.com/tilson-mateus-v9oyuq"
      ...
      <div class="container max-w-screen-xl mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row justify-between">
          <div class="mb-10 lg:mb-0">
            ...
            <p class="font-normal text-gray-500 text-xs md:text-base">I have brought here my biggest and favorite works
              <br> as a professional.
            </p>
          </div>
      ...
      <div class="container max-w-screen-xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div class="bg-gray-50 px-8 py-10 rounded-md">
            ...
            <p class="font-normal text-gray-500 text-md mb-4">Lorem ipsum dolor sit amet, consectetur <br> adipiscing
